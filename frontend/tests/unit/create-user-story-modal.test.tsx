...
import { CreateUserStoryModal } from '../../src/features/deliverables/components/create-user-story-modal';

vi.mock('../../src/features/form-templates/queries', () => ({
  useFormTemplates: () => ({
    data: [{ id: 'form-template-1', name: 'User story', templateFields: [] }],
  }),
}));
  ...
  render(
    <MantineProvider>
      <QueryClientProvider client={queryClient}>
        <CreateUserStoryModal opened onClose={onClose} onSubmit={onSubmit} />
      </QueryClientProvider>
    </MantineProvider>,
  );
...
describe('CreateUserStoryModal', () => {
  it('shows the "New user story" title', () => {
    renderModal();
