...
import { CreateFormTypeModal } from '../../src/features/form-types/components/create-form-type-modal';
...
function renderModal() {
  ...
  render(
    <MantineProvider>
      <CreateFormTypeModal opened onClose={onClose} onSubmit={onSubmit} />
    </MantineProvider>,
  );
